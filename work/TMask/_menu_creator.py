...
def create_node():
    ...
    try:
        ...
        # Avoid opening a heavy dynamic panel during node instantiation.
        # This reduces UI-time crashes on some Nuke builds when inserting
        # custom NDK nodes directly into a live branch.
        nuke.createNode(NODE_CLASS_NAME, inpanel=False)
